...
The basics of classes (since we finishedmost of the game before OOP concepts was taught in class, we learnt only the basics of classes in order to understand the functionality of the graphics library
