...
'''
The following lines in this multiline comment were initially used to input data into the file when it was first created. SInce the file already has this data it's not written in each time the module is imported.
